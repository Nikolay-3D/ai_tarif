...
### 4. **Добавление вызова в Google Календарь**
   - При бронировании вызова мастера информация автоматически добавляется в Google Календарь - мастер может просматривать вызовы.
...
- **Удобство**: Автоматическое добавление записей в календарь.
